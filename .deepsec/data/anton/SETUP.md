# Agent setup for `anton`

This is a deepsec scanning workspace. Project `anton` was just registered
(target: `..`). Setup is incomplete — `data/anton/INFO.md`
...
2. **Fill in `data/anton/INFO.md`.** It's auto-injected into the AI
...
pnpm deepsec process --project-id anton
```
