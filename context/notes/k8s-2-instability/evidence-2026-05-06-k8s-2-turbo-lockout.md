...
Onset: **not 2026-05-06**. Initial framing in this note (and the standalone fan-failure note at the time of capture) said the dropouts began at 02:55 CDT today. That was an artifact of in-cluster Prometheus's 14h retention window. A 7-day in-cluster Prom subquery surfaces fan1=0 readings on k8s-2 every day going back to **2026-04-29** (8 zeros), 04-30 (12), 05-01 (104), 05-02 (36), 05-03 (4), 05-04 (26), 05-05 (76), 05-06 (~448). k8s-1 and k8s-3 had zero zero-readings across all 8 days. Today's burst is the most severe day in a week-plus pattern, not the onset. Standalone note: [`evidence-2026-05-06-k8s-2-fan1-intermittent-failure.md`](evidence-2026-05-06-k8s-2-fan1-intermittent-failure.md) (corrected 2026-05-06 ~12:00 CDT).
...
The hypothesis chain explains the *throttle pattern* well. It does not yet explain *why today's fan-zero rate stepped up* (~448 today vs ~76 yesterday). The remote experiment to test "idle-mitigations rollout amplifies via NVMe thermal coupling" was invalidated at the precondition check: per-drive `pm_qos_latency_tolerance_us` on k8s-2 is at kernel default (100,000 µs), so the iter #15 module-param mitigation is a no-op on already-bound drives. The SN7100s are naturally APST-sleeping (80 % PS3 / 20 % PS4 over a 2h sample). Open candidates for the rate step-up are recorded in the standalone fan note: workload concentration, late-stage bearing degradation, ambient temperature, fan2 marginal wear. None directly testable remotely without provoking another bearing-stall episode.
