...
- 2026-08-09: Plan 0021 consolidated bucket provisioning but deliberately deferred an Iceberg acceptance module until ADR 0031's 2026-08-20 retain-or-remove review; the current Spark/Trino evidence workflow remains unchanged until that decision.
