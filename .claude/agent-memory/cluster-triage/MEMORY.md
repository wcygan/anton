...
- [NodeUnexpectedReboot disambiguation](reference_reboot_alert_disambiguation.md) — alert can fire on node-exporter series reset, not just real reboots; cross-check `/proc/uptime` before paging
