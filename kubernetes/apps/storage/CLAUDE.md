...
**Two chart-0.1.14 bugs we ship workarounds for**, both documented in `docs/docs/notes/seaweedfs-baseline-2026-04-19.md`. Don't touch either without reading the note first:
